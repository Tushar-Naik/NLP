...
public class BakUp extends JFrame {
	...
	public BakUp() throws IOException {
		spellCheckOn = true;
		autoCompleteOn = true;
...
//------------------ Actual Logic of Autocomplete ------------------------
    ...
    public  void showSuggestion() {
		...
		System.out.println("SubWord= "+lastWord);
	...
	private KeyListener k1 = new KeyAdapter() {
        ...
        public void keyReleased(KeyEvent e)
        {
			...
			if(autoCompleteOn)
        	{
				if (e.getKeyCode() == KeyEvent.VK_DOWN) {
					moveDown();
					System.out.println("moving down: if");
				}
		...
		public void keyPressed(KeyEvent e) {
			...
			SaveAs.setEnabled(true);
			System.out.println("typed test="+area.getText()+"|");	
				...
				if (separator.contains(e.getKeyChar()))//e.getKeyChar() == ' ' || e.getKeyChar() == '.'|| e.getKeyChar() == '\n' || e.getKeyChar() == ','|| e.getKeyChar() == ';')
				{
					...
					if (word.length() > 1) {
						...
						try {
							...
							System.out.println("Caret Pos after deletion:"+area.getCaretPosition());
